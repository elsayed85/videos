...
@section('title',__('Admin Static Word'))
@section('content')
<div class="box admin-form-main-block mrg-t-40">
	<div class="box-header with-border">
		...
		<div class="box-title">{{__('AdminStatic Word Translations For Language')}}: {{ $findlang->name }}
		</div>
	</div>

	<ul class="nav nav-tabs">
	   <li class="active"><a data-toggle="tab" href="#home">{{__('Admin StaticWord Translation')}}</a></li>
	</ul>
	<br/> 
