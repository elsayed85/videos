...
<div class="breadcrumbbar">
  <div class="row align-items-center">
      <div class="col-md-8 col-lg-8">
          <h4 class="page-title">{{ __('Social Logins Settings') }}</h4>
                          ...
                          @if($element->key != 'messanger')
                            <div class="col-md-3">
                              <div class="form-group text-dark{{ $errors->has('enable_whatsapp') ? ' has-error' : '' }}">
                                <h6 class="bootstrap-switch-label">{{__('Enable OFF/ON')}}</h6>
                          ...
                          @if($element->key != 'messanger')
                            <div class="col-md-3">
                              <div class="form-group text-dark{{ $errors->has('position') ? ' has-error' : '' }}">
                                <h6 class="bootstrap-switch-label">{{__('Position OFF/ON')}}</h6>
