...
{{----youtube API ModalEnd --}}
    <div class="col-lg-6 col-xl-6">
      <div class="card m-b-30">
        <div class="card-header">
            ...
            data-target=".bd-example-modal-lg"><i class="fa fa-file-excel-o mr-2"></i> {{ __('Import  Episodes') }} </button>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      {{-- Import Model End --}}
          ...
          <h5 class="box-title">{{__('Manage Season')}} </h5><h6>{{__('Of')}} {{$season->tvseries->title}} Season
            {{$season->season_no}}
            @if ($season->tmdb == 'Y')
                ...
                <tr>
                  ...
                  <td>
                    <div class="admin-table-action-block side-table-action">
                      @can('tvseries.edit')
                        <a href="{{route('edit_episodes',['id'=>$season->id,'ep_id'=>$episode->id])}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}" class="btn btn-round btn-outline-primary"><i class="fa fa-pencil"></i></a>
                      </button>
                      @endcan
                      @can('tvseries.view')
                      <a href="{{route('episode.link', $episode->id)}}" data-toggle="tooltip" data-original-title="{{__('links')}}" class="btn btn-round btn-outline-success"><i class="fa fa-link"></i></a>
                      @endcan
                      @can('tvseries.delete')
                      <button type="button" data-toggle="modal" data-target="#delete{{$episode->id}}" class="btn btn-round btn-outline-danger">
