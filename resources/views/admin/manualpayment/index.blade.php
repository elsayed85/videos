        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    data-target=".bd-example-modal-lg"><i class="feather icon-plus mr-2"></i> {{ __('Add New') }} </button>
                                ...
                                @foreach($methods as $key=> $m)
                                    <tr>
                                        ...
                                        @can('manual-payment.edit')
                                            <button type="button" data-toggle="modal" data-target="bd-example-modal-lg{{ $m->id }}" class="btn btn-round btn-outline-primary">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </button>
                                        @endcan
                                        @can('manual-payment.delete')
                                            <button type="button" data-toggle="modal" data-target="#delete{{ $m->id }}" class="btn btn-round btn-outline-danger">
