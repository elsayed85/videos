        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    data-target=".bd-example-modal-lg"><i class="feather icon-plus mr-2"></i> {{ __('Install New Addon') }} </button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('addon.install') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-outline-primary"><i class="fa fa-plus"></i> {{__('Install')}}</button>
