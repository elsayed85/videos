...
<div class="contentbar"> 
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{route('label.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
                class="feather icon-plus mr-2"></i>{{ __('Add Labels') }} </a>
                    <h5 class="card-title">{{ __('All Labels') }}</h5>
                    
                </div> 

                <div class="card-body">
                    <div class="table-responsive">
                         <table id="labelTable" class="table table-borderd">
...
<script>
 ...
 <script>
  $(function () {
    ...
    jQuery.noConflict();
    var table;
    if($.fn.dataTable.isDataTable('#labelTable')){
