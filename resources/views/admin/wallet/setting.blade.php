...
<div class="breadcrumbbar">
  <div class="row align-items-center">
      <div class="col-md-8 col-lg-8">
          <h4 class="page-title">{{ __('Wallet Setting') }}</h4>
        ...
        <!-- ======= Facebook Login start ========== -->
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-12">
                      <div class="bg-primary ml-6 mr-6 mb-6">
                        <div class="card-header text-dark"><h4><i class="feather icon-Settings" aria-hidden="true"></i> {{__('ENABLE PAYMENT OPTIONS ON WALLET')}}</h4></div>
                    </div>
                  </div>
                        ...
                        <div class="form-group text-dark{{ $errors->has('stripe_enable') ? ' has-error' : '' }}">
                          <h6 class="bootstrap-switch-label">{{__('Enable In Stripe ? OFF/ON')}}</h6>
                      ...
                      <div class="col-md-4">
                        <div class="form-group text-dark{{ $errors->has('paytm_enable') ? ' has-error' : '' }}">
                          <h6 class="bootstrap-switch-label">{{__('Enable In Paytm ? OFF/ON')}}</h6>
                      ...
                      <div class="col-md-4">
                        <div class="form-group text-dark{{ $errors->has('paypal_enable') ? ' has-error' : '' }}">
                          <h6 class="bootstrap-switch-label">{{__('Enable In Paypal ? OFF/ON')}}</h6>
