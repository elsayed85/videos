      ...
      <div class="col-md-8 col-lg-8">
          ...
          <div class="breadcrumb-list">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('App Settings') }}</li>
              </ol>
          </div>
      </div>
  </div>          
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{__('App Settings')}}</h5>
        </div>
        <div>
        <div class="card-body ml-2 app-settings-page">
                    ...
                    <div class="row mx-2 my-4 pb-3">
                      ...
                      <div class="col-md-6">
                        <div class="search form-group text-dark{{ $errors->has('purchase_code') ? ' has-error' : '' }}">
                          ...
                          <input type="text" value="{{ old('purchase_code') }}" name="purchase_code" id="purchase_code-field" class="form-control">
                          <small class="text-danger">{{ $errors->first('purchase_code') }}</small>
                        </div>
                      </div>
                              
                      <div class="col-md-6 col-lg-6 col-xl-12 form-group"> 
                        <button type="reset" class="btn btn-danger-rgba mr-2"><i class="fa fa-ban mr-1"></i>{{__('Reset')}}</button>
                        <button type="submit" class="btn btn-primary-rgba" id="send_form"><i class="fa fa-check-circle"></i> {{$appconfig->generate_apikey != NULL ?  __('RE-GENREATE KEY') : __('GET YOUR KEY') }}</button>
                      </div>
                    </div>
                  </div>
              </div>
          ...
          <div class="col-md-6 col-lg-6 col-xl-12">
            <div class="bg-info-rgba ml-6 mr-6 mb-6">
              <div class="card-header text-dark"><h5 class="mb-0"><i class="feather icon-settings"></i> {{__('APP SETTINGS')}}</h5></div>
              <div class="payment-gateway-block">
                <div class="row mx-2 my-4 pb-3">
                  <div class="col-md-6">
          ...
          <div class="col-md-6 col-lg-6 col-xl-12">
            <div class="bg-info-rgba ml-6 mr-6 mb-6 ">
              <div class="card-header text-dark"><h5 class="mb-0 "><i class="feather icon-settings"></i> {{__('PAYMENT GATEWAY SETTINGS')}}</h5></div>
              <div class="payment-gateway-block">
          ...
          <div class="col-md-6 col-lg-6 col-xl-12">
            <div class="bg-info-rgba ml-6 mr-6 mb-6">
              <div class="card-header text-dark"><h5 class="mb-0 "><i class="feather icon-settings"></i> {{__('SOCIAL LOGIN SETTINGS')}}</h5></div>
              <div class="payment-gateway-block">
                <div class="row my-4 pb-3">
                  <div class="col-lg-6">
                    <div class="form-group">
          ...
          <div class="col-md-6 col-lg-6 col-xl-12">
            <div class="bg-info-rgba ml-6 mr-6 mb-6">
              <div class="card-header text-dark"><h5 class="mb-0"><i class="feather icon-settings"></i> {{__('ADMOB SETTINGS ')}}</h5></div>
              <div class="payment-gateway-block">
                <div class="row my-4 pb-3">
                  <div class="col-lg-6">
                    <div class="form-group">
          ...
          <div class="col-md-6 col-lg-6 col-xl-12">
            <div class="bg-info-rgba ml-6 mr-6 mb-6">
              <div class="card-header text-dark"><h5 class="mb-0"><i class="feather icon-settings"></i> {{__('PUSH NOTIFICATION SETTINGS ')}}</h5></div>
              <div class="payment-gateway-block">
                <div class="row my-4 pb-3">
                  <div class="col-lg-6">
                    <div class="form-group">
          ...
          <div class="col-md-6 col-lg-6 col-xl-12">
            <div class="bg-info-rgba ml-6 mr-6 mb-6 ">
              <div class="card-header text-dark"><h5 class="mb-0"><i class="feather icon-settings"></i> {{__('OTHER SETTINGS')}}</h5></div>
              <div class="payment-gateway-block">
                <div class="row my-4 pb-3">
                  <div class="col-lg-6">
                    <div class="form-group">
