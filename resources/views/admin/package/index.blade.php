...
<div class="contentbar"> 
    <div class="row">
        <div class="col-md-12">
            ...
            @endcan
            @can('package.create')
            <a href="{{route('packages.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
           ...
           {{--  @if($package->delete_status == 1) --}}
              ...
              <tr  class="sortable row1" data-id="{{ $package->id }}">
                ...
                <td>
                  ...
                  <button type="submit" class="btn btn-rounded btn-danger">{{__('De Active')}}</button>
                  @else
                  <input type="hidden" value="active" name="status">
                  <button type="submit" class="btn btn-rounded btn-success">{{__('Active')}}</button>
                  @endif
                  </form>
                </td>
                <td>
                  <div class="admin-table-action-block">
                    @if($package->delete_status == 1)
                    @can('package.edit')
                    <a class="btn btn-round btn-outline-primary" data-original-title="{{__('Restore Package')}}" style="cursor: not-allowed" ><i class="fa fa-pencil"></i></a>
                    @endcan
