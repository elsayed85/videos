      ...
      <div class="card-header movie-create-heading">
        <div class="row">
          <div class="col-lg-4 col-4">
            <h5 class="card-title">{{ __('All Live Events') }}</h5>
          </div>
          <div class="col-lg-8 col-8">
            ...
            <a href="{{route('liveevent.create')}}" class="float-right btn btn-primary-rgba mb-2 mr-2"><i
            ...
            data-target=".bd-example-modal-lg"><i class="fa fa-file-excel-o mr-2"></i> {{ __('Import Live Events') }} </button>
                      ...
                      <div class="modal-header">
                          ...
                          <div class="col-md-12">
                              <div class="card-header">
                                  <a href="{{ url('files/Liveevents.xlsx') }}" class="float-right btn btn-success-rgba mr-2"><i
                      ...
                      @endif
                        ...
                        <div class="dropdown card-dropdown">
                            ...
                            <div class="dropdown-menu pull-right" aria-labelledby="dropdownMenuButton-{{$item->id}}">
                              @can('liveevent.view')
                                <a class="dropdown-item" href="{{url('event/detail', $item->slug)}}" target="__blank"><i class="feather icon-monitor mr-2"></i>{{__('Page Preview')}}</a>        
                              @endcan
                              @can('liveevent.edit')                                
                                <a class="dropdown-item" href="{{ route('liveevent.edit', $item->id)}}"><i class="feather icon-edit mr-2"></i> {{__('Edit')}}</a>     
                              @endcan
                              @can('liveevent.delete')                                 
