      ...
      <div class="card-header movie-create-heading">
        <div class="row">
          <div class="col-lg-4 col-4">
            <h5 class="card-title">{{ __('All Movie') }}</h5>
          </div>
          <div class="col-lg-8 col-8">
            ...
            @endcan
            @can('movies.create')
            <a href="{{route('movies.create')}}" class="float-right btn btn-primary-rgba mb-2 mr-2"><i
            ...
            data-target=".bd-example-modal-lg"><i class="fa fa-file-excel-o mr-2"></i> {{ __('Import Movies') }} </button>
              ...
              <div class="card">
                ...
                <div class="dropdown card-dropdown">
                  ...
                  <div class="dropdown-menu pull-right" aria-labelledby="dropdownMenuButton-{{$item->id}}">
                    ...
                    @endcan
                      <a class="dropdown-item" href="{{route('movies.link', $item->id)}}"><i class="feather icon-link-2 mr-1"></i> Add more links</a>
                  </div>
                </div>
