	...
	<div class="breadcrumbbar">
        <div class="row align-items-center">
            ...
            data-target="#bulk_delete"><i class="feather icon-trash mr-2"></i> {{ __('Delete Selected') }} </button>
              <a href="{{route('landing-page.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
                  class="feather icon-plus mr-2"></i>{{ __('Create A Block') }}</a>
            </div>
                          ...
                          <tr id="item-{{$block->id}}">
                            ...
                            <td>
                              <div class="admin-table-action-block">
                                <a href="{{route('landing-page.edit', $block->id)}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}" class="btn btn-round btn-outline-primary"> <i class="fa fa-edit"></i></a>
                                <button type="button" class="btn btn-round btn-outline-danger" data-toggle="modal" data-target="#delete{{$block->id}}"><i class="fa fa-trash"></i> </button>
                              </div>
                            </td>
                          </tr>
