	...
	<div class="breadcrumbbar">
        <div class="row align-items-center">
            ...
            data-target="#bulk_delete"><i class="feather icon-trash mr-2"></i> {{ __('Delete Selected') }} </button>
              <a href="{{ route('home_slider.create') }}" class="float-right btn btn-primary-rgba mr-2"><i
                      ...
                      <tr class="sortable row1" data-id="{{ $home_slide->id }}">
                        ...
                        <td>
                          <div class="admin-table-action-block">
                            <a href="{{route('home_slider.edit', $home_slide->id)}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}" class="btn btn-round btn-outline-primary"> <i class="fa fa-edit"></i></a>
                            <button type="button" class="btn btn-round btn-outline-danger" data-toggle="modal" data-target="#delete{{$home_slide->id}}"><i class="fa fa-trash"></i> </button>
                          </div>
                        </td>
                      </tr>
                      <!-- Delete Modal -->
