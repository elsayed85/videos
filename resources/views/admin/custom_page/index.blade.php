	...
	<div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">{{ __('All Custom Page') }}</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="{{url('/admin')}}">{{ __('Dashboard') }}</a></li>
                      <li class="breadcrumb-item active" aria-current="page">{{ __('All Custom Page') }}</li>
                    </ol>
                </div>
            </div>
...
<div class="contentbar"> 
    <div class="row">
        <div class="col-md-12">
            ...
            @endcan
            @can('pages.create')
            <a href="{{route('custom_page.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
                class="feather icon-plus mr-2"></i>{{ __('Create Custom Page') }} </a>
            @endcan
                    <h5 class="card-title">{{ __('All Custom Page') }}</h5>
