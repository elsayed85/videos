	...
	<div class="breadcrumbbar">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-4">
              <a href="{{url('admin/plan')}}" class="float-right btn btn-primary-rgba mr-2"><i
          ...
          <h5 class="box-title">{{__('User Name')}}: {{$user->name}}</h5>
            ...
            <h5 class="box-title">{{__('Last Subscription Plan')}}: {{$planname}}</h5>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-primary-rgba"><i class="fa fa-check-circle"></i>{{ __('Change Subscription') }}</button>
              </div>
          {!! Form::close() !!}
        </div>
      </div>
