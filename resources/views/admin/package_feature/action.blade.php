<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
      @can('package-feature.edit')
      <a class="dropdown-item" href="{{route('package_feature.edit', $id)}}"><i class="feather icon-edit mr-2"></i>{{ __("Edit") }}</a>
      @endcan
  ...
  <div class="modal-dialog modal-sm">
      <div class="modal-content">
          ...
          <div class="modal-footer">
              <form method="post"
                  action="{{route("package_feature.destroy", $id)}}"
                  class="pull-right">
                  {{csrf_field()}}
                  {{method_field("DELETE")}}
