...
<!-- ============ App link Start =========================== -->
  <div class="col-md-6 col-lg-6 col-xl-12 mb-4">
    <div class="bg-info-rgba ml-6 mr-6 mb-6">
      <div class="card-header text-dark"><h4><i class="feather icon-settings" aria-hidden="true"></i> {{__('App Settings')}}</h4></div>
      <div class="row mx-2 my-4">
        ...
        <div class="col-md-10">
          <div id="ip_block_link" style="{{ $button->ip_block=='1' ? "" : "display: none" }}"class="custom_toggle-checkbox form-group{{ $errors->has('ipblock_ip') ? ' has-error' : '' }}">
            <label class="text-dark">{{ __('Blocked Ips:') }}</label>
        ...
        <div class="col-md-10">
          <div id="donation_link"  style="{{ $config->donation=='1' ? "" : "display: none" }}" class="custom_toggle-checkbox form-group{{ $errors->has('donation_link') ? ' has-error' : '' }}">
            ...
            <small>{{ __('Get Donation link by register on ') }}<a target="__blank" href="https://www.paypal.com/in/webapps/mpp/paypal-me"> Paypal.me</a></small>
            <div class="invalid-feedback">
                {{ __('Please Enter Link !') }}.
            </div>
          </div>
...
<!-- ============ App link end =========================== -->
  <div class="col-md-6 col-lg-6 col-xl-12 mb-4">
    <div class="bg-info-rgba ml-6 mr-6 mb-6">
      ...
      <div class="row mx-2 my-4 custom_toggle-checkbox form-group{{ $errors->has('commingsoon_enabled_ip') ? ' has-error' : '' }}" id="comming_soon_link" style="{{ $config->comming_soon=='1' ? "" : "display: none" }}">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <small class="text-danger">{{ $errors->first('comming_soon_text') }}</small>
            <label for="promo_link">{{ __('Coming Soon Text') }}:</label>
      ...
      <div class="row mx-2 my-4">
        <div class="col-md-6">
          <div class="custom_toggle-checkbox form-group{{ $errors->has('is_toprated') ? ' has-error' : '' }}">
            <label class="text-dark" for="status">{{ __('Toprated Section') }}</label>
            <br>
        ...
        <div class="col-md-6">
          <div class="custom_toggle-checkbox form-group{{ $errors->has('free_sub') ? ' has-error' : '' }}">
            <label class="text-dark">{{ __('Free Trial') }}</label><br>
      ...
      <div class="col-md-3">
        <div class="custom_toggle-checkbox form-group{{ $errors->has('wel_eml') ? ' has-error' : '' }}">
          @if(env('MAIL_DRIVER') != NULL && env('MAIL_HOST') != NULL && env('MAIL_PORT'))
            <label class="text-dark">{{ __('Welcome Email For User') }} :</label><br>
        ...
        <div class="col-md-3">
          <div class="custom_toggle-checkbox form-group{{ $errors->has('verify_email') ? ' has-error' : '' }}">
            <label class="text-dark">{{ __('Verify Email For User') }} :</label><br>
            <input type="checkbox" name="verify_email" {{ $config->verify_email == 1 ? "checked" : "" }} class='custom_toggle' >
            <div>
              <small>{{ __('(If you enable it, a welcome email will be sent to users register email id, make sure you updated your mail setting in Site Setting >> Mail Settings before enable it.)') }}</small>
            </div>
          </div>
        </div>
  ...
  <div class="col-md-3">
    <div class="custom_toggle-checkbox form-group{{ $errors->has('age_restriction') ? ' has-error' : '' }}">
          <label class="text-dark">{{ __('Age Restriction') }} : </label><br>
          {!! Form::checkbox('age_restriction', 1, ($config->age_restriction == '1' ? 1 : 0), ['class' => 'custom_toggle']) !!}
          <div>
            <small>{{ __('(Age Restriction will be taken from Maturity Rating in Movies and TVSeries)') }}</small>
          </div>
      </div>
  </div>
  ...
  <div class="col-md-3">
    <div class="custom_toggle-checkbox form-group{{ $errors->has('user_rating') ? ' has-error' : '' }}">
          <label class="text-dark">{{ __('User Rating') }}: </label><br>
...
<div class="row mx-2 my-4">
  <div class="col-md-3">
    <div class="custom_toggle-checkbox form-group{{ $errors->has('download') ? ' has-error' : '' }}">
          <label class="text-dark">{{ __('Download Video') }} : </label><br>
          {!! Form::checkbox('download', 1, ($config->download == '1' ? 1 : 0), ['class' => 'custom_toggle download']) !!}
          <div>
            <small>{{ __('(This option is Available only if you Upload a Video)') }}</small>
          </div>
      </div>
  </div>
...
<div class="col-md-3">
  ...
  <div class="col-md-3">
    <div class="custom_toggle-checkbox form-group{{ $errors->has('remove_subscription') ? ' has-error' : '' }}">
          <label class="text-dark">{{ __('Remove Subscription On Landing Page') }} :</label><br>
...
<div class="row mx-2 my-4">
  <div class="col-md-3">
    <div class="custom_toggle-checkbox form-group{{ $errors->has('preloader') ? ' has-error' : '' }}">
          <label class="text-dark">{{ __('Pre loader') }} :</label><br>
  ...
  <div class="col-md-3">
    <div class="custom_toggle-checkbox form-group{{ $errors->has('inspect') ? ' has-error' : '' }}">
          <label class="text-dark">{{ __('Inspect Disable') }} :</label><br>
  ...
  <div class="col-md-3">
    <div class="custom_toggle-checkbox form-group{{ $errors->has('catlog') ? ' has-error' : '' }}">
          <label class="text-dark">{{ __('Catlog View') }} :</label><br>
          {!! Form::checkbox('catlog', 1, ($config->catlog == 1 ? 1 : 0), ['class' => 'custom_toggle checkk', 'onChange' =>'withoutlogin()']) !!}
          <div>
              <small>{{ __('(Allow user to Access website without Subscription, but can not Play Video)') }}</small>
          </div>
      </div>
      <div class="col-md-12">
...
<div class="row mx-2 my-4">
  <div class="col-md-3">
    <div class="custom_toggle-checkbox form-group{{ $errors->has('rightclick') ? ' has-error' : '' }}">
          <label class="text-dark">{{ __('Right click Disable') }} : </label><br>
