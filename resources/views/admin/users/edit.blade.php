            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input value="{{ $user->name }}" autofocus required name="name" type="text" class="form-control"
                    placeholder="{{ __('Please Enter Your Name') }}" />
                </div>

                <div class="form-group">
                  <label for="mobile"> {{ __('Mobile Number') }}:</label>
                  <input value="{{ $user->mobile }}" type="number" name="mobile"
                    placeholder="{{ __('Please enter your mobileno') }} "
                    class="form-control">
                </div>
                <div class="form-group">
                  <label for="email">{{ __('Email Address') }}:<sup class="text-danger">*</sup> </label>
                  <input value="{{ $user->email }}" required type="email" name="email"
                    placeholder="{{ __('eg: foo@bar.com') }}"
                    class="form-control">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea name="address" class="form-control" rows="1"
                    placeholder="{{ __('Please Enter Your Address') }}" value="{{ $user->address }}">{{ $user->address }}</textarea>
                </div>
