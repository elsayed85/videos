        ...
        <div class="card m-b-30">
            <div class="card-body">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-movie" role="tab" aria-controls="pills-home" aria-selected="true">{{__('Movies')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-tv" role="tab" aria-controls="pills-profile" aria-selected="false">{{__('TVShows')}}</a>
                    </li>
                </ul>
                                ...
                                <tbody>
                                    @foreach ($movies as $key => $movie)
                                        <tr>
                                            ...
                                            <td><i class="fa fa-eye"></i> {{ views($movie)->unique()->count() + $movie->views }}</td>
                                            <td>
                                                <a href="{{url('/admin/fakeViews/'.$movie->id.'/edit')}}" class="btn btn-round btn-outline-primary"> <i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                    ...
                                    <tbody>
                                        @foreach ($season as $key => $s)
                                            <tr>
                                                ...
                                                <td><i class="fa fa-eye"></i> {{ views($s)->unique()->count() + $s->views }}</td>
                                                <td>
                                                    <a href="{{url('/admin/fakeSeasonViews/'.$s->id.'/edit')}}" class="btn btn-round btn-outline-primary"> <i class="fa fa-edit"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
