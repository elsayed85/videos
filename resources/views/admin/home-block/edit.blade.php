            ...
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">{{ __('Edit Home Block') }}</li>
                    </ol>
                </div>
            </div>
            <div class="col-md-4 col-lg-4">
              <div class="widgetbar">
                <a href="{{url('admin/home-block')}}" class="btn btn-primary-rgba mr-2"><i
    ...
    <div class="col-lg-6">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{__('Edit Home Block')}}</h5>
        </div>
