	...
	<div class="breadcrumbbar">
        <div class="row align-items-center">
            ...
            data-target="#bulk_delete"><i class="feather icon-trash mr-2"></i> {{ __('Delete Selected') }} </button>
              <a href="{{route('home-block.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
                  class="feather icon-plus mr-2"></i>{{ __('Add Promotion Settings Block') }}</a>
            </div>
                      ...
                      <td>{{$home_block->tvseries ? $home_block->tvseries->title : '-'}}</td>
                        ...
                        <td>
                          <div class="admin-table-action-block">
                            <a href="{{route('appslider.edit', $home_block->id)}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}" class="btn btn-round btn-outline-primary"> <i class="fa fa-edit"></i></a>
                            <button type="button" class="btn btn-round btn-outline-danger" data-toggle="modal" data-target="#delete{{$home_block->id}}"><i class="fa fa-trash"></i> </button>
                          </div>
                        </td>
                      </tr>
                      <!-- Delete Modal -->
