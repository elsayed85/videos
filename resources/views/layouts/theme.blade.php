              ...
              <li class="sign-in-block admin-dropdown">
                <div class="dropdown prime-dropdown">
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-lg-6">
                        <ul class="admin-list">
                          ...
                          @if($auth->is_admin != 1)
                          @if($button->producer_approval==1 && $auth->producer_status == 0)
                          <li><a href="" data-toggle="modal" data-target="#myModalproducer">{{__('Become An Producer')}}</a></li>
                          @else
                          <li><a href="{{url('producer/subscription')}}">{{__('Producer Subscription Plans')}}</a></li>
                          @endif
                          @endif
                          @endif
                          @if(getSubscription()->getData()->subscribed == true)
                          ...
                          @endif
                          @if(isset($button) && $button->movie_request == 1)
                          <li><a href="" data-toggle="modal" data-target="#myModalmovierequest">{{__('Request a Movie')}}</a></li>
                          @endif
                  ...
                  <!-- <ul class="dropdown-menu prime-dropdown-menu">
                    ...
                    @if($auth->is_assistant == 1)
                      <li>
                        <a href="{{url('admin')}}" target="_blank"> {{__('Producer Dashboard')}}</a>
                      </li>
                    @endif
                    @if(getSubscription()->getData()->subscribed == true)
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">{{ __('Become A Producer') }}</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body">  
        <form id="demo-form2" method="POST" action="{{url('request-producer')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="id"  value="{{$auth->id}}" />                      
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="fname">{{ __('User Name') }} : <sup class="redstar">*</sup></label>
                <input type="text" class="form-control" name="name" id="title" placeholder="  {{ __('Enter Your Name') }}" value="{{$auth->name}}" required  >  
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="email">{{ __('Email') }} : <sup class="redstar">*</sup></label>
                <input type="email" class="form-control" name="email" id="title" placeholder="{{('Enter Email')}}" value="{{$auth->email}}"  >
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="number">{{ __('Age') }} : <sup class="redstar">*</sup></label>
                <input type="number" value="{{$auth->age}}" class="form-control" name="age" id="title" placeholder="{{('Enter Age')}}" >
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="contact">{{ __('Mobile') }} : <sup class="redstar">*</sup></label>
                <input type="number" class="form-control" name="mobile" id="contact" placeholder="{{ __('Enter Mobile No') }}" value="{{$auth->mobile}}" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="file">{{ __('Upload Your ID Proof') }} : <sup class="redstar">*</sup></label>
                <input type="file" class="form-control" name="govtid" id="file" value="{{$auth->govtid}}" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="file">{{ __('Upload Your Image') }} : <sup class="redstar">*</sup></label>
                <input type="file" class="form-control" name="image" id="file" value="{{$auth->image}}" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label for="textarea">{{ __('Description') }} : <sup class="redstar">*</sup></label>
      ...
      @else
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">{{ __('You Already sent a request for Producer') }}</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body"> 
        <form id="demo-form2" method="POST" action="{{url('cancel-request-producer')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
          @csrf
          <div class="box-footer">
            <button type="submit" class="btn btn-lg col-md-3 btn-danger">{{ __('Cancel Request') }}</button>
          </div>
        </form>
      </div>
      @endif
...
<div class="modal fade" data-backdrop="" id="myModalmovierequest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      @auth
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">{{ __('Request A Movie') }}</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body">  
        <form id="demo-form2" method="POST" action="{{url('request-movie')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="id"  value="{{$auth->id}}" />                      
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label for="fname">{{ __('Movie Request Name') }} : <sup class="redstar">*</sup></label>
                <input type="text" class="form-control" name="mr_name" id="title" placeholder="  {{ __('Enter Your Requet Movie Name') }}"  required  >  
              </div>
            </div>
          </div>
  ...
  <div class="small-screen-navigation">
    <nav class="sidenav" id="mySidenav" role="navigation">
      ...
      <ul class="nav sidebar-nav">
        ...
        @if(Auth::user() && $auth != NULL && getSubscription()->getData()->subscribed == true)
          <li style="width:13%;padding: 0px">
            <a href="{{route('get.kids', Auth::user()->id)}}" style="background-image: url({{ asset('images/kids.png') }});background-repeat: no-repeat;background-size: contain;margin: 0px 15px;padding: 18px 31px !important;"></a>
          </li>
        @endif
      @endif
    @else
      @if(Auth::user() && $auth != NULL && getSubscription()->getData()->subscribed == true)
      <li style="width:13%;padding: 0px">
        <a style="background-image: url({{ asset('images/kids.png') }});background-repeat: no-repeat;background-size: contain;margin: 0px 15px;padding: 18px 31px !important;"></a>
      </li>
      @endif
    @endif
    @endif
