...
<!-- main wrapper -->
  <section class="main-wrapper main-wrapper-single-movie-prime">
            ...
            <div class="col-md-8">
              <div class="full-movie-dtl-block">
                    ...
                    <li><i title="views" class="fa fa-eye"></i> {{ views($movie)
                      ...
                      <li>
                        <div class="dropdown rating-dropdown">
                          <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-star"></i> {{__('Rate')}}
                  ...
                  @if(checkInMovie($movie) == true && isset($movie->video_link))
                    @if($movie->maturity_rating == 'all age' || $age>=str_replace('+', '',$movie->maturity_rating))
                      ...
                      @else
                        ...
                        <a href="{{route('watchmovie',$movie->id)}}" class="iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('Play Now')}}</span>
                          </a>
                ...
                @if(isset($movie->multilinks) && count($movie->multilinks) > 0 )   
                  ...
                  @if(in_array(1, $mlc))
                     <button type="button" class="btn btn-default watch-trailer-btn" data-toggle="collapse" data-target="#downloadmovie">{{__('Download')}}</button>
                ...
                @if($auth && getSubscription()->getData()->subscribed == true)
                  @if(isset($season->episodes[0]) && checkInTvseries($season->tvseries) == true && isset($season->episodes[0]->video_link))
                    @if($season->tvseries->age_req =='all age' || $age>=str_replace('+', '',$season->tvseries->age_req))
                      ...
                      @else
                        <a href="{{ route('watchTvShow',$season->id)  }}" class="iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('Play Now')}}</span></a>
                      @endif
                    @else
    ...
    <div class="genre-prime-block movie-series-section search-section starring-section">
      <div class="container-fluid">
        <h5 class="section-heading">{{__('starring')}} </h5>
                ...
                @if(isset($actor_detail) && $actor_detail != NULL) 
                  <li>
                    <div class="genre-slide-image actor_detail">
                      <a href="{{url('video/detail/actor_search',$actor_detail->slug)}}">
                        @php
                      ...
                      <div class="des-btn-block des-in-list">
                        @if($auth && getSubscription()->getData()->subscribed == true)
                          @if($single_series->is_upcoming != 1)
                            @if(checkInMovie($single_series) == true && isset($single_series->video_link))
                              @if($single_series->maturity_rating == 'all age' || $age>=str_replace('+', '',$single_series->maturity_rating))
                                ...
                                @else
                                  ...
                                  <a href="{{route('watchmovie',$single_series->id)}}" class="iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('Play Now')}}</span>
                                    </a>
                        ...
                        @if($catlog ==0 && getSubscription()->getData()->subscribed == true)
                          @if (isset($wishlist_check->added))
                            <a onclick="addWish({{$single_series->id}},'{{$single_series->type}}')" class="watch-trailer-btn addwishlistbtn{{$single_series->id}}{{$single_series->type}} btn-default">{{$wishlist_check->added == 1 ? __('Remove From Watchlist') : __('Add to Watchlist')}}</a>
                          @else
                            <a onclick="addWish({{$single_series->id}},'{{$single_series->type}}')" class="watch-trailer-btn addwishlistbtn{{$single_series->id}}{{$single_series->type}} btn-default">{{__('Add to Watchlist')}}</a>
                          @endif
                        @elseif($catlog ==1 && $auth)
                          @if (isset($wishlist_check->added))
                            <a onclick="addWish({{$single_series->id}},'{{$single_series->type}}')" class="watch-trailer-btn addwishlistbtn{{$single_series->id}}{{$single_series->type}} btn-default">{{$wishlist_check->added == 1 ? __('Remove From Watchlist') : __('Add to Watchlist')}}</a>
    ...
    @if(isset($filter_series) && $movie->series == 1)
      @if(count($filter_series) > 0)
        <div class="container-fluid movie-series-section search-section">
          <h5 class="movie-series-heading">{{__('Series')}} {{count($filter_series)}}</h5>
          <div>
                    ...
                    <div class="movie-series-section">
                      ...
                      <div class="des-btn-block des-in-list">
                        ...
                        @if($series->is_upcoming != 1)
                          @if(checkInMovie($series) == true && isset($series->video_link))
                        ...
                        @endif
                          @if($series->trailer_url != null || $series->trailer_url != '')
                            <a href="{{ route('watchTrailer',$series->id)  }}" class="watch-trailer-btn iframe btn btn-default">{{__('Watch Trailer')}}</a>
                          @endif
                        @else
                           @if($series->trailer_url != null || $series->trailer_url != '')
                            <a href="{{ route('guestwatchtrailer',$series->id)  }}" class="watch-trailer-btn iframe btn btn-default">{{__('Watch Trailer')}}</a>
                          @endif
                        @endif
                        @if($catlog ==0 && getSubscription()->getData()->subscribed == true)
                          @if (isset($wishlist_check->added))
                        ...
                        @if(isset($series->multilinks) && count($series->multilinks) > 0 )   
                          @if(Auth::user() && getSubscription()->getData()->subscribed == true)
                            @if(in_array(1, $mlc))
                               <button type="button" class="btn btn-sm btn-default download-btn watch-trailer-btn" data-toggle="collapse" data-target="#downloadmovie{{$series->id}}">{{__('download')}}</button>
                  ...
                  <div class="col-lg-10">
                    <div class="movie-series-section">
                      <div class="row">
                        <div class="col-lg-8"> 
                          @if($auth && getSubscription()->getData()->subscribed == true)
                            @if(checkInTvseries($episode->seasons->tvseries) == true && isset($episode->video_link))
                              @if($episode->seasons->tvseries->maturity_rating =='all age' || $age>=str_replace('+', '',$episode->seasons->tvseries->maturity_rating))
                                ...
                                @endif
                              @else
                                <a onclick="myage({{$age}})" class="btn btn-play btn-sm-play watch-trailer-btn"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"><h5 class="movie-series-heading movie-series-name">{{$key+1}}. {{$episode->title}}</h5></span></a>
                              @endif
                            @else
                      ...
                      @if(isset($episode->multilinks) &&  count($episode->multilinks) >0)
                        @if(Auth::user() && getSubscription()->getData()->subscribed == true)
                          @if(in_array(1, $elc))
                            ...
                            <button type="button" class="btn btn-default download-btn watch-trailer-btn" data-toggle="collapse" data-target="#downloadtvseries{{$episode->id}}">{{__('download')}}</button>
    ...
    @if($prime_genre_slider == 1)
      ...
      @if (isset($all) && count($all) > 0)
        <div class="genre-prime-block">
          <div class="container-fluid">
            <h5 class="section-heading">{{__('Customer Also Watched')}}</h5>
                      ...
                      <div class="genre-slide-image home-prime-slider protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block{{$item->id}}">
                        ...
                        @else
                         ...
                         @if(isset($item->is_upcoming) && $item->is_upcoming == 1)
                            <span class="badge bg-success">{{__('Up Coming')}}</span>
                          @endif
                        @endif
                      </div>
                        ...
                        <div class="des-btn-block">
                          @if($auth  && getSubscription()->getData()->subscribed == true)
                            ...
                            @if($item->trailer_url != null || $item->trailer_url != '')
                              <a href="{{ route('watchTrailer',$item->id) }}" class="iframe btn-default">{{__('Watch Trailer')}}</a>
                            @endif
                          @else
                            @if($item->trailer_url != null || $item->trailer_url != '')
                              <a href="{{ route('guestwatchtrailer',$item->id) }}" class="iframe btn-default">{{__('Watch Trailer')}}</a>
                            @endif
                          @endif
