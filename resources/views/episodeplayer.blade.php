...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background-color:#999999; padding:0px; margin:0px;">	
        ...
        <p class="minimalDarkCategoriesTitle"><span class="minimialDarkBold">{{__('Title')}}: {{ $episode->seasons->title }}</span></p>
        <p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold">{{__('Description')}}: </span>{{ $episode->seasons->detail }}</p>
      	</li>
        ...
        @endphp
		  ...
		  @else
			 ...
			 data-poster-source="{{asset('images/tvseries/posters/'.$episode->seasons->tvseries->poster)}}" data-subtitle-soruce="[
