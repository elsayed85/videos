      ...
      <div class="row">
          ...
          <div class="col-lg-12">
              ...
              <div class="alert alert-success alert-dismissible fade show">
                  ...
                  <form action="<?php echo e(url("/admin/merge-quick-update")); ?>" method="POST" class="float-right d-none updaterform">
                      <?php echo csrf_field(); ?>
                      ...
                      <div class="card m-b-30 shadow-sm">
                          <div class="card-body">
                              ...
                              <div class="col-6 text-right">
                                  <a href="<?php echo e(url('admin/users')); ?>"><i
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                      <div class="card m-b-30 shadow-sm">
                          <div class="card-body">
                              <div class="row align-items-center">
                                  <div class="col-6">
                                      <h4><?php echo e($movies_count); ?></h4>
                                      <p class="font-12 mb-0"><?php echo e(__('Total Movies')); ?></p>
                                  </div>
                                  <div class="col-6 text-right">
                                      <a href="<?php echo e(url('admin/movies')); ?>"><i
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                      <div class="card m-b-30 shadow-sm">
                          <div class="card-body">
                              <div class="row align-items-center">
                                  <div class="col-6">
                                      <h4><?php echo e($tvseries_count); ?></h4>
                                      <p class="font-14 mb-0"><?php echo e(__('Total Tv Serieses')); ?></p>
                                  </div>
                                  <div class="col-6 text-right">
                                      <a href="<?php echo e(url('admin/tvseries')); ?>"><i
                  ...
                  <div class="col-lg-3 col-md-6 col-12 mt-md-3">
                      <div class="card m-b-30 shadow-sm">
                          <div class="card-body">
                              <div class="row align-items-center">
                                  <div class="col-7">
                                      <h4><?php echo e($livetv_count); ?></h4>
                                      <p class="font-14 mb-0"><?php echo e(__('Total Live Tv')); ?></p>
                                  </div>
                                  <div class="col-5 text-right">
                                      <a href="<?php echo e(url('admin/livetv')); ?>"><i
                                          class="text-success feather icon-video icondashboard"></i></a>
                                      </div>
                              </div>
                          </div>
                  ...
                  <div class="col-lg-3 col-md-6 col-12 mt-md-3">
                      <div class="card m-b-30 shadow-sm">
                          <div class="card-body">
                              <div class="row align-items-center">
                                  <div class="col-6">
                                      <h4><?php echo e($package_count); ?></h4>
                                      <p class="font-14 mb-0"><?php echo e(__('Total Packages')); ?></p>
                                  </div>
                                  <div class="col-6 text-right">
                                      <a href="<?php echo e(url('admin/packages')); ?>"><i
                  ...
                  <div class="col-lg-3 col-md-6 col-12 mt-md-3">
                      <div class="card m-b-30 shadow-sm">
                          <div class="card-body">
                              <div class="row align-items-center">
                                  <div class="col-6">
                                      <h4><?php echo e($coupon_count); ?></h4>
                                      <p class="font-12 mb-0"><?php echo e(__('Total Coupons')); ?></p>
                                  </div>
                                  <div class="col-6 text-right">
                                      <a href="<?php echo e(url('admin/coupons')); ?>"><i
                  ...
                  <div class="col-lg-3 col-md-6 col-12 mt-md-3">
                      <div class="card m-b-30 shadow-sm">
                          <div class="card-body">
                              <div class="row align-items-center">
                                  <div class="col-6">
                                      <h4><?php echo e($genres_count); ?></h4>
                                      <p class="font-12 mb-0"><?php echo e(__('Total Genres')); ?></p>
                                  </div>
                                  <div class="col-6 text-right">
                                      <a href="<?php echo e(url('admin/genres')); ?>"><i
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                    <div class="card m-b-30 shadow-sm">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <h4><?php echo e($movieslw); ?></h4>
                                    <p class="font-12 mb-0"><?php echo e(__('Top 10 Movies')); ?></p>
                                </div>
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(url('admin/topmovies')); ?>"><i
                                        class="text-success feather icon-video icondashboard"></i></a>
                                    </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">                                
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h5 class="card-title mb-0"><?php echo e(__('Revenue Report')); ?></h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sayed/Desktop/Next Hour/nexthour/resources/views/admin/index.blade.php ENDPATH**/ ?>