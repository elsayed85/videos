...
<body class="bg-black">
        ...
        <div class="container__child signup__form">
          <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="form-group">
              <label for="password-confirm"><?php echo e(__('Repeat Password')); ?></label>
  ...
  <script type="text/javascript" src="<?php echo e(url('js/recaptcha_api.js')); ?>"></script>
</body>
</html><?php /**PATH /home/sayed/Desktop/Next Hour/nexthour/resources/views/auth/register.blade.php ENDPATH**/ ?>