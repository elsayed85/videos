<!-- Fevicon -->
<link rel="shortcut icon" href="<?php echo e(url('images/favicon/favicon.png')); ?>">
<!-- Start css -->
<!-- Apex css -->
...
<!-- jQuery ui css -->
<link href="<?php echo e(url('assets/plugins/jquery-ui/jquery-ui.min.css')); ?>" rel="stylesheet" type="text/css">
<link href="<?php echo e(url('assets/plugins/toolbar/jquery.toolbar.css')); ?>" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="<?php echo e(url('assets/plugins/colorpicker/bootstrap-colorpicker.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(url('vendor/midia/dropzone.css')); ?>" />
<!-- <link rel="stylesheet" href="<?php echo e(url('vendor/midia/clipboard.css')); ?>" /> -->
<link rel="stylesheet" href="<?php echo e(url('css/star-rating.min.css')); ?>" type="text/css">
<link rel="stylesheet" href="<?php echo e(url('vendor/midia/midia.css')); ?>" />
<!-- End css -->
<?php echo $__env->yieldContent('stylesheet'); ?>
<?php /**PATH /home/sayed/Desktop/Next Hour/nexthour/resources/views/layouts/head.blade.php ENDPATH**/ ?>