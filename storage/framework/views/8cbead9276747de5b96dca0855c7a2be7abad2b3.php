            ...
            <ul>
              ...
              <li class="sign-in-block admin-dropdown">
                <div class="dropdown prime-dropdown">
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-lg-6">
                        <ul class="admin-list">
                          ...
                          <li>
                            <a href="<?php echo e(url('admin')); ?>" target="_blank">
                              <?php echo e(__('Producer Dashboard')); ?></a>
                          </li>
                          <?php endif; ?>
                          <li><a href="<?php echo e(url('account')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
                          <?php if(Module::find('Producer') && Module::find('Producer')->isEnabled()): ?>
                          <?php if($auth->is_admin != 1): ?>
                          <?php if($button->producer_approval==1 && $auth->producer_status == 0): ?>
                          <li><a href="" data-toggle="modal" data-target="#myModalproducer"><?php echo e(__('Become An Producer')); ?></a></li>
                          <?php else: ?>
                          <li><a href="<?php echo e(url('producer/subscription')); ?>"><?php echo e(__('Producer Subscription Plans')); ?></a></li>
                          <?php endif; ?>
                          <?php endif; ?>
                          <?php endif; ?>
                          <?php if(getSubscription()->getData()->subscribed == true): ?>
                          <li><a href="<?php echo e(route('protectedvideo')); ?>"><?php echo e(__('Protected Content')); ?></a></li>
                          <?php else: ?>
                          <li><a href="<?php echo e(url('account/purchaseplan')); ?>"><?php echo e(__('Subscribe')); ?></a></li>
                          <?php endif; ?>
                          <?php if(isset($button) && $button->movie_request == 1): ?>
                          <li><a href="" data-toggle="modal" data-target="#myModalmovierequest"><?php echo e(__('Request a Movie')); ?></a></li>
                          <?php endif; ?>
                      ...
                      <div class="col-sm-6 col-lg-6">
                        <ul>
                          ...
                          <li><a
                              href="<?php echo e(url('/manageprofile/mus/'.Auth::user()->id)); ?>"><?php echo e(__('Manage Profile')); ?></a>
                          </li>
                          <?php endif; ?>
                          <?php
                          ...
                          <li><a href="<?php echo e(route('2fa.get')); ?>"><?php echo e(__('2Factor Authentication')); ?></a></li>
                          <?php endif; ?>
                          <?php
                  ...
                  <!-- <ul class="dropdown-menu prime-dropdown-menu">
                    <?php if($auth->is_admin == 1): ?>
                      <li><a href="<?php echo e(url('admin')); ?>" target="_blank"><?php echo e(__('Admin Dashboard')); ?></a></li>
                    <?php endif; ?>
                    <?php if($auth->is_assistant == 1): ?>
                      <li>
                        <a href="<?php echo e(url('admin')); ?>" target="_blank"> <?php echo e(__('Producer Dashboard')); ?></a>
                      </li>
                    <?php endif; ?>
                    <?php if(getSubscription()->getData()->subscribed == true): ?>
                      <li><a href="<?php echo e(url('protected/content')); ?>"><?php echo e(__('Protected Content')); ?></a></li>
                    ...
                    <?php if(isset(Auth::user()->paypal_subscriptions) && $subscribed == 1): ?>
                      <li><a href="<?php echo e(url('/manageprofile/mus/'.Auth::user()->id)); ?>"><?php echo e(__('Manage Profile')); ?></a></li>
                    <?php endif; ?>
                    <?php
             ...
             <?php endif; ?>
              ...
              <li class="sign-in-block sign-in-block-one sign-in-block-two mrgn-rt-20"><a class="sign-in"
                  href="<?php echo e(url('login')); ?>"><i class="flaticon-login"></i> <?php echo e(__('Sign in')); ?></a></li>
...
<div class="modal fade" data-backdrop="" id="myModalproducer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <?php if(auth()->guard()->check()): ?>
      <?php if(Auth::user()->producer == 0): ?>
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"><?php echo e(__('Become A Producer')); ?></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body">  
        <form id="demo-form2" method="POST" action="<?php echo e(url('request-producer')); ?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <input type="hidden" name="id"  value="<?php echo e($auth->id); ?>" />                      
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="fname"><?php echo e(__('User Name')); ?> : <sup class="redstar">*</sup></label>
                <input type="text" class="form-control" name="name" id="title" placeholder="  <?php echo e(__('Enter Your Name')); ?>" value="<?php echo e($auth->name); ?>" required  >  
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="email"><?php echo e(__('Email')); ?> : <sup class="redstar">*</sup></label>
                <input type="email" class="form-control" name="email" id="title" placeholder="<?php echo e(('Enter Email')); ?>" value="<?php echo e($auth->email); ?>"  >
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="number"><?php echo e(__('Age')); ?> : <sup class="redstar">*</sup></label>
                <input type="number" value="<?php echo e($auth->age); ?>" class="form-control" name="age" id="title" placeholder="<?php echo e(('Enter Age')); ?>" >
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="contact"><?php echo e(__('Mobile')); ?> : <sup class="redstar">*</sup></label>
                <input type="number" class="form-control" name="mobile" id="contact" placeholder="<?php echo e(__('Enter Mobile No')); ?>" value="<?php echo e($auth->mobile); ?>" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="file"><?php echo e(__('Upload Your ID Proof')); ?> : <sup class="redstar">*</sup></label>
                <input type="file" class="form-control" name="govtid" id="file" value="<?php echo e($auth->govtid); ?>" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="file"><?php echo e(__('Upload Your Image')); ?> : <sup class="redstar">*</sup></label>
                <input type="file" class="form-control" name="image" id="file" value="<?php echo e($auth->image); ?>" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label for="textarea"><?php echo e(__('Description')); ?> : <sup class="redstar">*</sup></label>
                <textarea id="discription" name="discription" rows="5" cols="116"></textarea>
              </div>
            </div>
          </div>
      ...
      <?php else: ?>
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"><?php echo e(__('You Already sent a request for Producer')); ?></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body"> 
        <form id="demo-form2" method="POST" action="<?php echo e(url('cancel-request-producer')); ?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <div class="box-footer">
            <button type="submit" class="btn btn-lg col-md-3 btn-danger"><?php echo e(__('Cancel Request')); ?></button>
          </div>
        </form>
      </div>
      <?php endif; ?>
...
<!--MOVIE REQUEST FORM-->
<div class="modal fade" data-backdrop="" id="myModalmovierequest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <?php if(auth()->guard()->check()): ?>
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"><?php echo e(__('Request A Movie')); ?></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body">  
        <form id="demo-form2" method="POST" action="<?php echo e(url('request-movie')); ?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <input type="hidden" name="id"  value="<?php echo e($auth->id); ?>" />                      
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label for="fname"><?php echo e(__('Movie Request Name')); ?> : <sup class="redstar">*</sup></label>
                <input type="text" class="form-control" name="mr_name" id="title" placeholder="  <?php echo e(__('Enter Your Requet Movie Name')); ?>"  required  >  
              </div>
            </div>
          </div>
...
<!--MOVIE REQUEST FORM END-->
  ...
  <div class="small-screen-navigation">
    <nav class="sidenav" id="mySidenav" role="navigation">
      ...
      <ul class="nav sidebar-nav">
        ...
        <?php if(Auth::user() && $auth != NULL && getSubscription()->getData()->subscribed == true): ?>
          <li style="width:13%;padding: 0px">
            <a href="<?php echo e(route('get.kids', Auth::user()->id)); ?>" style="background-image: url(<?php echo e(asset('images/kids.png')); ?>);background-repeat: no-repeat;background-size: contain;margin: 0px 15px;padding: 18px 31px !important;"></a>
          </li>
        <?php endif; ?>
      <?php endif; ?>
    <?php else: ?>
      <?php if(Auth::user() && $auth != NULL && getSubscription()->getData()->subscribed == true): ?>
      <li style="width:13%;padding: 0px">
        <a style="background-image: url(<?php echo e(asset('images/kids.png')); ?>);background-repeat: no-repeat;background-size: contain;margin: 0px 15px;padding: 18px 31px !important;"></a>
      </li>
      <?php endif; ?>
    <?php endif; ?>
    <?php endif; ?>
        ...
        <li class="sign-in-block">
          <div class="dropdown prime-dropdown">
            ...
            <ul class="dropdown-menu prime-dropdown-menu">
              ...
              <?php if($auth->is_assistant == 1): ?>
              <li>
                <a href="<?php echo e(url('admin/movies')); ?>" target="_blank"> <?php echo e(__('Producer Dashboard')); ?></a>
              </li>
              <?php endif; ?>
              ...
              <?php endif; ?>
              <?php if(isset(Auth::user()->paypal_subscriptions) && $subscribed == 1): ?>
              <li><a href="<?php echo e(url('/manageprofile/mus/'.Auth::user()->id)); ?>"><?php echo e(__('Manage Profile')); ?></a>
              </li>
              <?php endif; ?>
              <?php
              ...
              <li><a href="<?php echo e(route('custom.logout')); ?>"> <?php echo e(__('Sign Out')); ?> </a> </li>
            </ul>
          </div>
        </li>
        <?php endif; ?>
        ...
        <li class="sign-in-block sign-in-block-one sign-in-block-two"><a class="sign-in" href="<?php echo e(url('login')); ?>"><i
              class="flaticon-login"></i> <?php echo e(__('Sign-in')); ?></a></li>
        <li class="sign-in-block sign-in-block-one "><a class="sign-in" href="<?php echo e(url('register')); ?>"><i
              class="flaticon-profile"></i><?php echo e(__('Register')); ?></a></li>
        <?php endif; ?>
      </ul>
  ...
  <div class="purchase-sticky">
    <p><?php echo e(__('pleasesubscribetoaplan')); ?> &nbsp;<a href="<?php echo e(url('account/purchaseplan')); ?>"><button
          class="btn btn-sm text-white agree_btn js-cookie-consent-agree cookie-consent__agree"><?php echo e(__('Click Here')); ?></button></a>
    </p>
  </div>
  <?php endif; ?>
  <?php endif; ?>
    ...
    <div class="container-fluid">
      ...
      <div class="copyright">
        ...
        <ul>
          ...
          <li><a href="<?php echo e(url('terms_condition')); ?>"><?php echo e(__('Terms and Condition')); ?></a></li>
          <?php endif; ?>
          <?php if(isset($configs->privacy_pol) && $configs->privacy_pol != NULL): ?>
          <li><a href="<?php echo e(url('privacy_policy')); ?>"><?php echo e(__('Privacy Policy')); ?></a></li>
          <?php endif; ?>
          <?php if(isset($configs->refund_pol) && $configs->refund_pol != NULL): ?>
          <li><a href="<?php echo e(url('refund_policy')); ?>"><?php echo e(__('Refund Policy')); ?></a></li>
          <?php endif; ?>
          <li><a href="<?php echo e(url('faq')); ?>"><?php echo e(__('Help')); ?></a></li>
          <li><a href="<?php echo e(url('contactus')); ?>"><?php echo e(__('Contact Us')); ?></a></li>
        </ul>
      </div>
    </div>
  </footer>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="footer-widgets">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="footer-links-block">
                    <h4 class="footer-widgets-heading"><?php echo e(__('Site-map')); ?></h4>
                    <ul>
          ...
          <div class="col-md-3">
            <div class="footer-widgets subscribe-widgets">
              ...
              <p class="subscribe-text"><?php echo e(__('Subscribe Text')); ?></p>
...
</html>s<?php /**PATH /home/sayed/Desktop/Next Hour/nexthour/resources/views/layouts/theme.blade.php ENDPATH**/ ?>