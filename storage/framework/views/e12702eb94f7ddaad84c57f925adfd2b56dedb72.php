...
<?php $__env->startSection('title','Pay '.session()->get('currenct_currency') . $amount); ?>
...
<section id="main-wrapper" class="main-wrapper user-account-section wallet-block">
  <div class="container-fluid">
    ...
    <h5><?php echo e(__('ADD')); ?> &nbsp;<i class="<?php echo e($currency_symbol); ?>"></i> <?php echo e($amount); ?> <?php echo e(__('via')); ?></h5>
    <hr>
    ...
    <?php if($wallet_settings->paytm_enable == 1): ?>
      <div class="mt-2 shadow-sm card">
        ...
        <div class="card-body">
          <h5 class="card-title"><?php echo e(__("Pay with PAYTM")); ?>

          </h5>
          
            <p class="card-text">
                <?php echo e(__("Netbanking, Debit / Credit Card, Paytm wallet, UPI available")); ?>

            </p>
            
            <form action="<?php echo e(route('wallet.add.using.paytm')); ?>" method="POST">
              <?php echo csrf_field(); ?>
              <input type="hidden" value="<?php echo e($amount); ?>" name="amount">
              <button type="submit" class="btn btn-default">
                <span><?php echo e(__('Pay')); ?> <i class="<?php echo e($currency_symbol); ?>"></i> <?php echo e($amount); ?> </span> 
              </button>
            </form>
        </div>
      </div>
    ...
    <?php if($wallet_settings->paypal_enable == 1): ?>
      <div class="mt-2 shadow-sm card">
        ...
        <div class="card-body">
          <h5 class="card-title"><?php echo e(__("Pay with Payapl")); ?>

          </h5>

            <p class="card-text">
              <?php echo e(__("Netbanking, Debit / Credit Card, Paytm wallet")); ?>

          </p>
            
            <form action="<?php echo e(route('wallet.add.using.paypal')); ?>" method="POST">
              <?php echo csrf_field(); ?>
              <input type="hidden" value="<?php echo e($amount); ?>" name="amount">
              <button type="submit" class="btn btn-default">
                <span><?php echo e(__('Pay')); ?> &nbsp;<i class="<?php echo e($currency_symbol); ?>"></i> <?php echo e($amount); ?></span> 
    ...
    <?php if($wallet_settings->stripe_enable == 1): ?>
      <div class="mt-2 shadow-sm card">
        ...
        <div class="card-body">
          <h5 class="card-title"><?php echo e(__("Pay with STRIPE")); ?>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
              <form method="POST" action="<?php echo e(route('wallet.add.using.stripe')); ?>" id="credit-card" class="StripeCard">
                <?php echo csrf_field(); ?>
                
                <div class="form-group">
                  <input class="form-control" placeholder="<?php echo e(__('Card number')); ?>" type="tel" name="number">
                ...
                <div class="form-group">
                  <input class="form-control" placeholder="<?php echo e(__('Full name')); ?>" type="text" name="name">
                ...
                <div class="form-group">
                  <input class="form-control" placeholder="<?php echo e(__('CVC')); ?>" type="password" name="cvc">
                ...
                <input type="hidden" class="form-control" name="amount" value="<?php echo e($amount); ?>">
                
                <div class="form-group">
                  <button title="<?php echo e(__('Click to complete your payment !')); ?>" type="submit" class="btn btn-primary btn-lg btn-block" id="confirm-purchase"> <?php echo e(__('ADD')); ?> <i class="<?php echo e($currency_symbol); ?>"></i><?php echo e($amount); ?></button>
                </div>
              </form>
            </div>
...
<script src="<?php echo e(url('/js/card.js')); ?>"></script>
<script>
  "use strict";
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sayed/Desktop/Next Hour/nexthour/resources/views/user/walletpay.blade.php ENDPATH**/ ?>