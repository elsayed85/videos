<div class="leftbar">
                   ...
                   <div class="tab-pane fade active show" id="v-pills-dashboard" role="tabpanel" aria-labelledby="v-pills-dashboard">
                    ...
                    <ul class="vertical-menu">
                        ...
                        <?php if(Module::find('Producer') && Module::find('Producer')->isEnabled()): ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['producer-content.manage','packageforproducer.view','pendingrequest.view'])): ?>
                                <li class="<?php echo e(Nav::isRoute('addedmovies')); ?> <?php echo e(Nav::isRoute('addedTvSeries')); ?> <?php echo e(Nav::isRoute('addedLiveTv')); ?>

                                <?php echo e(Nav::isResource('packageforproducer')); ?> <?php echo e(Nav::isResource('pendingrequest')); ?>">
                                    <a href="javaScript:void();" class="menu"><i class="feather icon-users text-secondary"></i>
                                    <span><?php echo e(__('Producer')); ?><div class="sub-menu truncate"><?php echo e(__('Producer Package, All Producer Request, Added Movies, Added Tv Series, Added Live Tv, Payment Details, Payment Settings, Revenue Request')); ?></div></span><i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                        ...
                                        <li>
                                            ...
                                            href="<?php echo e(url('/admin/pendingrequest')); ?>"><?php echo e(__('All Producer Request')); ?></a>
                                        </li>
                                        <?php endif; ?>
                                        <?php endif; ?>
                                        <li>
                                            <a class="<?php echo e(Nav::isRoute('addedmovies')); ?>" 
                                            href="<?php echo e(route('addedmovies')); ?>"><?php echo e(__('Added Movies')); ?></a>
                                        </li>
                                        <li>
                                            <a class="<?php echo e(Nav::isRoute('addedTvSeries')); ?>" 
                                            href="<?php echo e(route('addedTvSeries')); ?>"><?php echo e(__('Added Tv Series')); ?></a>
                                        </li>
                                        <li>
                                            <a class="<?php echo e(Nav::isRoute('addedLiveTv')); ?>" 
                                            href="<?php echo e(route('addedLiveTv')); ?>"><?php echo e(__('Added Live Tv')); ?></a>
                                        </li>
                                        <li>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['menu.view','menu.create','menu.edit','menu.delete','package.view','package-feature.view'])): ?>
                            ...
                            <li class="<?php echo e(Nav::isResource('menu')); ?>">
                                <a href="<?php echo e(url('/admin/menu')); ?>">
                                    <i class="ion ion-ios-menu"></i><span><?php echo e(__('Menu')); ?></span>
                                </a>
                            </li>
                        ...
                        <li class="<?php echo e(Nav::isResource('movies')); ?>">
                            <a href="<?php echo e(url('/admin/movies')); ?>">
                                <i class="fa fa-file-movie-o"></i></i><span><?php echo e(__('Movie')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="<?php echo e(Nav::isResource('tvseries')); ?>">
                            <a href="<?php echo e(url('/admin/tvseries')); ?>">
                                <i class="ion ion-md-tv"></i><span><?php echo e(__('Tv Series')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="<?php echo e(Nav::isResource('livetv')); ?>">
                            <a href="<?php echo e(url('/admin/livetv')); ?>">
                                <i class="ion ion-ios-tv"></i><span><?php echo e(__('Live Tv')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="<?php echo e(Nav::isResource('liveevent')); ?>">
                            <a href="<?php echo e(url('/admin/liveevent')); ?>">
                                <i class="ion ion-md-calendar"></i><span><?php echo e(__('Live Event')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="<?php echo e(Nav::isResource('audio')); ?>">
                            <a href="<?php echo e(url('/admin/audio')); ?>">
                                <i class="fa fa-music"></i><span><?php echo e(__('Audio')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                        <?php endif; ?>
                        <li class="<?php echo e(Nav::isResource('moviesreq')); ?>">
                            <a href="<?php echo e(url('/admin/movies-req')); ?>">
                                <i class="fa fa-file-movie-o"></i></i><span><?php echo e(__('Movies Request')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['genre.view','actor.view','director.view','audiolanguage.view','label.view'])): ?>
                            <li class="<?php echo e(Nav::isResource('genres')); ?><?php echo e(Nav::isResource('directors')); ?> <?php echo e(Nav::isResource('actors')); ?><?php echo e(Nav::isResource('audio_language')); ?> <?php echo e(Nav::hasSegment('label')); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['coupon.view','notification.manage','affiliate.settings','affiliate.history','comment-settings.comments','comment-settings.subcomments','fake.views'])): ?>
                            ...
                            <?php echo e(Nav::isResource('fakeViews')); ?>">
                                <a href="javaScript:void();" class="menu"><i class="socicon-itchio"></i>
                                    <span><?php echo e(__('Marketing')); ?><div class="sub-menu truncate"><?php echo e(__('All Coupons, Notification, Affiliate Settings, Affiliate Reports, Comments, Sub Comments, Fake Views')); ?></div></span><i class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupon.view')): ?>
                                    <li>
                                        <a class="<?php echo e(Nav::isResource('coupons')); ?>"
                                            href="<?php echo e(url('/admin/coupons')); ?>"><?php echo e(__('All Coupons')); ?></a>
                                    </li>
                                    <?php endif; ?>
                        ...
                        <li class="<?php echo e(Nav::isRoute('addonmanger.index')); ?>">
                            <a class="nav-link" href="<?php echo e(route('addonmanger.index')); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['front-settings.sliders','front-settings.sliders','front-settings.auth-customization','pages.view','front-settings.short-promo','front-settings.social-icon','faq.view'])): ?>
                        ...
                        'site-settings.language'])): ?>
                            <li class="<?php echo e(Nav::isResource('settings')); ?> <?php echo e(Nav::isResource('seo')); ?> <?php echo e(Nav::isResource('mail')); ?> <?php echo e(Nav::isResource('api')); ?> <?php echo e(Nav::isRoute('chat.index')); ?> 
                            <?php echo e(Nav::isRoute('sociallogin')); ?> <?php echo e(Nav::isRoute('term_con')); ?><?php echo e(Nav::isRoute('manual.payment.gateway')); ?> 
                            <?php echo e(Nav::isRoute('pri_pol')); ?> <?php echo e(Nav::isRoute('refund_pol')); ?><?php echo e(Nav::isRoute('adsense')); ?> 
                            <?php echo e(Nav::isRoute('copyright')); ?> <?php echo e(Nav::isRoute('term_con')); ?> <?php echo e(Nav::isRoute('pwa.setting.index')); ?> 
                            <?php echo e(Nav::isRoute('player.set')); ?> <?php echo e(Nav::isRoute('ads')); ?>  <?php echo e(Nav::isResource('manual-payment')); ?> 
                            <?php echo e(Nav::hasSegment('blocker')); ?> <?php echo e(Nav::isResource('languages')); ?> <?php echo e(Nav::isRoute('google.ads')); ?> <?php echo e(Nav::isRoute('admin.color.scheme')); ?>">
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li>
                                        <a class="<?php echo e(Nav::isRoute('manual.payment.gateway')); ?>" 
                                    ...
                                    <li>
                                        ...
                                        href="<?php echo e(url('/admin/manual-payment')); ?>"><?php echo e(__('Manual Payments')); ?></a>
                                    </li>
                                    <?php endif; ?>
                                    ...
                                    <li>
                                        <a class="<?php echo e(Nav::isRoute('customstyle')); ?>" 
                                        href="<?php echo e(url('admin/custom-style-settings')); ?>"><?php echo e(__('Custom Style')); ?></a>
                                    </li>
                                    <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['app-settings.setting','app-settings.slider'])): ?>
                            <li class="<?php echo e(Nav::isResource('appsettings')); ?> <?php echo e(Nav::isRoute('admob')); ?> <?php echo e(Nav::isResource('appslider')); ?>">
                                <a href="javaScript:void();"><i class="ion ion-ios-settings"></i>
                            ...
                            <li class="<?php echo e(Nav::isResource('upi')); ?>">
                                <a href="<?php echo e(route('upi')); ?>">
                                    <i class="fa fa-qrcode"></i></i><span><?php echo e(__('UPI')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <li class="<?php echo e(Nav::isResource('ProducerUrl')); ?>">
                            <a href="<?php echo e(url('/producer/url')); ?>">
                                <i class="ion ion-md-link"></i><span><?php echo e(__('Profile')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?> 
                    ...
                    <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['help.import-demo','help.db-backup','help.system-status','help.remove-public','help.clear-cache'])): ?>
                            <li class="<?php echo e(Nav::isRoute('admin.import.demo')); ?> <?php echo e(Nav::isRoute('admin.backup.settings')); ?> 
                            <?php echo e(Nav::isRoute('system.status')); ?> <?php echo e(Nav::isRoute('clear_cache')); ?> <?php echo e(Nav::isRoute('get.remove.public')); ?>">
                                <a href="javaScript:void();"><i class="ion ion-ios-settings"></i>
                                    <span><?php echo e(__('Help And Support')); ?><div class="sub-menu truncate"><?php echo e(__('Import Demo, Database Backup, System Status, Remove Public, Clear Cache')); ?></div></span><i class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                                    ...
                                    <li>
                                        <a class="<?php echo e(Nav::isRoute('system.status')); ?>" 
                                        href="<?php echo e(route('system.status')); ?>"><?php echo e(__('System Status')); ?></a>
                                    </li>
                                    <?php endif; ?>
    ...
    <!-- End Sidebar -->
</div><?php /**PATH /home/sayed/Desktop/Next Hour/nexthour/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>