    	...
    	<div class="col-lg-12">
      		<div class="card m-b-50">
        		<div class="card-header">
          			<h5 class="box-title"><?php echo e(__('My Profile')); ?></h5>
        		</div>
				...
				<div class="row mx-2">
					...
					<div class="col-md-6 col-lg-6 col-xl-6 mb-4">
						<div class="bg-info-rgba ml-6 mr-6 mb-6">
							<div class="card-header text-dark"><h5 class="mb-0"> <?php echo e(__('Change Email ')); ?></h5>
                ...
                <?php echo Form::open(['method' => 'POST', 'action' => 'UserAccountController@update_profile']); ?>
                        ...
                        <?php echo Form::label('new_email', __('New Email')); ?>
                  ...
                  <?php echo Form::open(['method' => 'POST', 'action' => 'UserAccountController@update_profile']); ?>
                    ...
                    <?php echo Form::close(); ?>
                        ...
                        <div class="form-group text-dark<?php echo e($errors->has('new_name') ? ' has-error' : ''); ?>">
                          <?php echo Form::label('new_name', __('New Name')); ?>
                    ...
                    <?php echo Form::close(); ?>
						...
						<div class="col-md-6 col-lg-6 col-xl-6 mb-4">
                          ...
                          <label for="image" class="btn btn-danger js-labelFile" data-toggle="tooltip" data-original-title="<?php echo e(__('Profile Image')); ?>">
                            <i class="icon fa fa-check"></i>
                            <span class="js-fileName"><?php echo e(__('Choose A File')); ?></span>
                          </label>
                          <p class="info"><?php echo e(__('Choose A Image')); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sayed/Desktop/Next Hour/nexthour/resources/views/admin/profile.blade.php ENDPATH**/ ?>