          ...
          <div class="user-account-tab">
            <div id="exTab1"> 
              <ul class="nav nav-pills" id="user-tab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="pills-affiliate-tab" data-toggle="pill" href="#affiliate" role="tab" aria-controls="pills-affiliate" aria-selected="false"><i class="fa fa-gift"></i><?php echo e(__('Dashboard')); ?></a>
                </li>
                <?php endif; ?>
              ...
              <div class="tab-pane fade active" id="details" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="edit-profile-main-block">
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                      <div class="edit-profile-block">
                        <h4 class="panel-setting-heading"><?php echo e(__('update age and mobile')); ?></h4>
                        <div class="info"><?php echo e(__('want to change age and mobile')); ?></div>
                        <form method="POST" action="<?php echo e(route('user.age')); ?>" accept-charset="UTF-8">
                          ...
                          <div class="form-group <?php echo e($errors->has('mobile') ? ' has-error' : ''); ?>">
                            <label for="mobile"><?php echo e(__('mobile no')); ?></label>
                      ...
                      <div class="edit-profile-block">
                        ...
                        <form method="POST" action="<?php echo e(route('user.address')); ?>" accept-charset="UTF-8">
                          ...
                          <div class="form-group <?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
                            ...
                            <textarea id="w3review" name="address" rows="4" cols="10"><?php if(isset(Auth::user()->address)): ?> <?php echo e(Auth::user()->address); ?> <?php endif; ?></textarea>
              ...
              <div class="tab-pane fade" id="paymenthistory" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="panel-setting-main-block billing-history-main-block">
                  ...
                  <?php if(isset($paypal_subscriptions) && $paypal_subscriptions != null && count($paypal_subscriptions) > 0): ?>
                    <div class="container">
                      <h4 class="plan-dtl-heading"><?php echo e(__('billinghistory')); ?></h4>
                      <div class="billing-history-block table-responsive">
                        <table class="table">
                          <thead>
                            <tr>
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sayed/Desktop/Next Hour/nexthour/resources/views/user/index.blade.php ENDPATH**/ ?>