        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    data-target=".bd-example-modal-lg"><i class="feather icon-plus mr-2"></i> <?php echo e(__('Install New Addon')); ?> </button>
                            ...
                            <div class="modal-body">
                                <form action="<?php echo e(route('addon.install')); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="<?php echo e(__('Envanto Purchase Code Of Your Addon')); ?>" class="form-control" name="purchase_code">
                                    </div>
            
                                    <div class="form-group">
                                        <label><?php echo e(__('ChooseZipFile')); ?>: <span class="text-danger">*</span></label>
                                        <input type="file" class="form-control" name="addon_file">
                                    </div>
            
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-outline-primary"><i class="fa fa-plus"></i> <?php echo e(__('Install')); ?></button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sayed/Desktop/Next Hour/nexthour/resources/views/admin/addonmanager/index.blade.php ENDPATH**/ ?>