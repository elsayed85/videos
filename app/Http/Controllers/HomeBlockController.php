...
class HomeBlockController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', __('Promotion Settings Block has been added'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/home-block')->with('success', __('Promotion Settings Block has been updated'));
    }
