...
class SocialLoginController extends Controller
{
    ...
    public function updateFacebookKey(Request $request)
    {
        ...
        return back()->with('success', 'Facebook Config Enabled');
    ...
    public function updateGoogleKey(Request $request)
    {
        ...
        return back()->with('success', 'Google Config updated');
    ...
    public function updategitlabKey(Request $request)
    {
        ...
        return back()->with('success', 'Gitlab Config is enabled !');
    ...
    public function updateamazonKey(Request $request)
    {
        ...
        return back()->with('success', __('Amazon Config updated'));
