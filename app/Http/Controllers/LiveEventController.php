...
class LiveEventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', __('LiveEvent has been added'));
    }
 ...
 */
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/liveevent')->with('success', __('LiveEvent has been updated'));
    }
    ...
    public function importliveevent(Request $request)
    {
        ...
        if (count($liveevents)) {
            ...
            return back()->with('success', __('Live Event imported successfully'));
