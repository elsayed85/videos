...
class DirectorController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->search != null) {
            ...
            $directors = Director::select('id', 'name', 'image', 'biography', 'place_of_birth','DOB', 'slug')->paginate(12);
        }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', __('Director has been created'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/directors')->with('success', __('Director has been updated'));
    }
    ...
    public function importdirectors(Request $request)
    {
        ...
        if (count($directors)) {
            ...
            return back()->with('success', __('Directors imported successfully'));
