...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'braintree_id', 'is_assistant', 'amazon_id', 'google2fa_secret', 'google2fa_enable', 'refer_code', 'refered_from','facebook_url','youtube_url','twitter_url','address','country','state','city','qr_code','discription','qrcode_enable','bankd_enable'
    ];
    ...
    {
        return $this->hasMany('App\MovieComment');
    }

    public function movie_subcomments()
    {
        return $this->hasMany('App\MovieSubcomment');
    }
